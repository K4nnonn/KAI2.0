...
if __name__ == "__main__":
    ...
    accounts = {
        'Retirement': (output_dir / 'Klai_Retirement_UNIFIED_20251106_133054_FINAL.xlsx', get_retirement_insights),
        'Brand': (output_dir / 'Klai_Brand_UNIFIED_20251106_133056_FINAL.xlsx', get_brand_insights),
        'Wealth_Management': (output_dir / 'Klai_Wealth_Management_UNIFIED_20251106_133056_FINAL.xlsx', get_wealth_insights),
        'Brokerage': (output_dir / 'Klai_Brokerage_UNIFIED_20251106_133058_FINAL.xlsx', get_brokerage_insights)
    }
